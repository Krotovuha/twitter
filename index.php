							...
							<div class="col-xl-10">
								<div class="d-flex">
									...
									<?php 
										...
										$post4_insert = mysqli_query($connect, "INSERT INTO post (author,image,texts)VALUES ('Mary Jane','img/8.webp','Я люблю свою собаку')");
								...
								<div>
									...
									<img src="<?php echo $post1['image']  ?> " class="w-100">
								</div>
							</div>
						</div>
						<div class="row mt-4">
							...
							<div class="col-xl-10">
								...
								<div>
									...
									<img src="<?php echo $post2['image']  ?> " class="w-100">
								</div>
							</div>
						</div>
					</div>
					<div class="row mt-4">
							...
							<div class="col-xl-10">
								...
								<div>
									...
									<img src="<?php echo $post3['image']  ?> " class="w-100">
								</div>
							</div>
						</div>
					...
					<div class="row mt-4">
							...
							<div class="col-xl-10">
								...
								<div>
									...
									<img src="<?php echo $post4['image']  ?> " class="w-100">
								</div>
							</div>
						</div>
				</div>
				<div class="col-sm-12 col-md-4 col-xl-3">
					...
					<div class="bg-white pt-3 pb-3 pl-3 pr-3">
						...
						<form action="insert.php" method="GET">
							...
							<input type="" name="channel" class="form-control mt-2" placeholder="название">
							<input type="" name="img" class="form-control mt-2" placeholder="картинка">
						   <button class="btn btn-primary mt-2">добавить в читаемые</button>
						</form>
						<div class="col-4">
							<h6>Читаемые</h6>
						</div>
						...
						<?php 
							$follow = mysqli_query($connect,'SELECT * FROM follow');
							$foll1 = $follow -> fetch_assoc();
						 ?>
						<div class="row mb-3">
							<div class="col-4">
								<a href=""><img class="w-100 rounded-circle" src="images/2.jpg"></a> <!-- аватарка, внутри ссылки картинка-->
